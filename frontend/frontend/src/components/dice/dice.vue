...
.scene-container {
  ...
  height: 500px;
  margin: 20px auto; /* Baja el dado un poco más */
  overflow: hidden; /* Asegura que el contenido no se desborde */
}

.result-display {
  position: absolute;
  top: 20%; /* Baja el resultado un poco más */
  left: 50%;
  transform: translate(-50%, -50%);
  background-color: white;
  color: #005f99; /* Azul como el dado */
  font-size: 4rem; /* Tamaño más pequeño */
  font-weight: bold;
  padding: 10px 20px;
  border-radius: 10px;
...
.roll-button {
  display: block;
  margin: 20px auto 0; /* Centra el botón debajo del dado */
  padding: 10px 20px;
  font-size: 16px;
  background-color: #005f99; /* Azul como el dado */
  color: white;
  border: none;
  border-radius: 5px;
  cursor: pointer;
